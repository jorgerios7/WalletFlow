...
const ButtonTab: React.FC<{
    ...
    return (
        <Pressable
            onPress={onPress}
            style={{
                width: '100%', padding: 10, flexDirection: 'row', justifyContent: iconName ? 'space-between' : 'center',
                ...
                borderBottomWidth: 0.5, backgroundColor: Colors[preferences.theme.appearance].surface, borderRadius: 10
            }}>
            <Text
                style={{
                    color: Colors[preferences.theme.appearance].textPrimary, alignSelf: 'center',
            ...
            {iconName && (
                <MaterialIcons name={iconName} size={iconSize ? iconSize : 22} color={Colors[preferences.theme.appearance].iconPrimary} />
            )}
        </Pressable>
    );
}
