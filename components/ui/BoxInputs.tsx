...
export default function BoxInputs({ children, style, ...props }: BoxInputsProps) {
  ...
  const dynamicStyle = { width: width - 50, alignSelf: "center" as const };
...
const styles = StyleSheet.create({
  wrapper: { flex: 1, height: "100%", justifyContent: "center", alignItems: "center" },
  gradient: { width: "100%", height: "100%", padding: 10, justifyContent: "center", alignItems: "center" },
  content: { backgroundColor: "transparent", borderRadius: 10, alignItems: "stretch" },
});
